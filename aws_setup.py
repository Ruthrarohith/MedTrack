...
SNS_TOPIC_ARN = os.getenv('SNS_TOPIC_ARN', 'arn:aws:sns:us-east-1:615299730511:Medtrack')
...
def patient_dashboard():
    ...
    # Safe sorting: convert to string to avoid datetime vs string comparison errors
