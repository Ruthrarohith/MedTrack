...
def launch_india_server():
    """
    Launches an EC2 instance in the US East (us-east-1) region.
    """
    print("🚀 Initiating Launch Sequence for US Server (us-east-1)...")
    
    # Configuration
    REGION = 'us-east-1'
    AMI_ID = 'ami-0c7217cdde317cfec' # Amazon Linux 2023 AMI in us-east-1 (Example - Verify before use)
    ...
    try:
        ...
        instances = ec2_resource.create_instances(
            ...
            TagSpecifications=[{
                ...
                'Tags': [{'Key': 'Name', 'Value': 'MedTrack-US-Server'}]
            }],
        ...
        print(f"\n✅ Server Deployed Successfully in US East (us-east-1)!")
        ...
        print(f"\n❌ Setup Failed: {e}")
        print("Note: Ensure you have valid AWS credentials configured for us-east-1.")
